...
module.exports = {
    ...
    resolve: {
        ...
        //     "child_process": false, // Assuming you do not need child process operations in the client-side code
    ...
    plugins: [
        ...
        //     process: 'process/browser', // Some packages might require the process polyfill
        //   }),
